...
<blockquote>
<p>If you want to know how to send message, see [Message](/api/message) <br>
If you want to know how to get contact, see [Contact](/api/contact)</p>
</blockquote>
</dd>
<dt>[Room](/api/room)</dt>
...
<dt>[ContactSelf](/api/contact_self)</dt>
...
| room-invite | <code>string</code> | Emit when there is a room invitation, see more in  [RoomInvitation](/api/?id=roominvitation)                                    If someone leaves the room by themselves, wechat will not notice other people in the room, so the bot will never get the "leave" event. |
...
| room-invite | <code>function</code> | (this: Wechaty, room: Room, leaverList: Contact[]) => void <br>                                        see more in  [RoomInvitation](/api/?id=roominvitation) |
