...
> If you want to know how to send message, see [Message](/api/message?id=top)
> If you want to know how to get contact, see [Contact](/api/contact?id=top)
...
* [Wechaty](/api/wechaty?id=top)
    ...
    * _instance_
        * [.on(event, listener)](#Wechatyonevent-listener) [<code>Wechaty</code>](/api/wechaty?id=top)
        ...
        * ~~[.self()](#Wechatyself)~~
        * [.userSelf()](#WechatyuserSelf) [<code>Contact</code>](/api/contact?id=top)
...
**Return the type of**: [<code>Wechaty</code>](/api/wechaty?id=top)
...
**Kind**: instance method of [<code>Wechaty</code>](/api/wechaty?id=top)  
**Returns**: [<code>Wechaty</code>](/api/wechaty?id=top) - - this for chain  
...
**Kind**: static method of [<code>Wechaty</code>](/api/wechaty?id=top)  
